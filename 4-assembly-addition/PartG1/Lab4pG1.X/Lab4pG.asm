...
SUBROUTINE_BCD:
 ...
 MOVWF   InA		    ; Move masked data from PORTA to input_a
 
 MOVLW   0x09            ; Load 0x09 into W

 CPFSGT  InA,1	    ;If input_a is Greater than 0x09 skip next line
 GOTO    OUTPUT	    ;GOTO OUTPUT   
    
 MOVLW   0x06	    ;Load 0x06 into W
 ADDWF   InA,0	    ;Add input_b and W and store in result 
 MOVWF   InA		    ;Move input_a into W   
