...
{    
    ...
    switch(Nec_state)
    {
        ...
        case 1 :
        {
            if(Time_Elapsed > 8500 && Time_Elapsed < 9500) // check if time elapsed value read is between 8500 usec and 9500 usec
            {
        ...
        {
            if(Time_Elapsed > 4000 && Time_Elapsed < 5000) // check if time elapsed value read is between 4000 usec and 5000 usec
            {
